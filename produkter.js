...
function changeToGreen() {
    if (currentVariant === "pink") { // Tjekker om den nuværende variant er Pink
        ...
        document.querySelector(".tekstBeskrivelseZeroGreen").innerHTML = `
            Zero Green er en forfriskende og sprudlende alkoholfri øl med en perfekt balance mellem syrlig lime og let bitterhed fra humlen. Den friske side: En let og perlende øl med friske noter af lime, der giver en sprød og opkvikkende smagsoplevelse.
            <br><br>Den aromatiske side: En velafstemt kombination af nøje udvalgte humler og let maltprofil, der sikrer dybde og balance i hver tår.
        `;
